...
h = e.substring(0, f);
j = e.substring(0, e.length-f);

while(j.length+f < 0x40000) {
    j = j+j+h;
}
...
x = a.substring(0, y);
z = a.substring(0, a.length-y);

while(z.length+y < 0x40000) {
    z = z+z+x;
}
